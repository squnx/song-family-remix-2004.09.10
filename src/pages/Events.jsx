        ...
        <div className="container">
          <div className="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            <ul className="gallery-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
              ...
              <li data-filter=".filter-1st-birthday">1st Birthday</li>
              {/* <li data-filter=".filter-commencement">Commencement</li> */}
              <li data-filter=".filter-grandpa">Grandpa's Farewell</li>
              <li data-filter=".filter-usc">UCSB</li>
              <li data-filter=".filter-usc">USC</li>
              <li data-filter=".filter-school">Wedding</li>
            </ul>
